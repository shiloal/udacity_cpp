...
ChatBot::ChatBot(const ChatBot &source) 			// Copy constructor
{
  ...
  *_image = *source._image;
  ...
  std::cout << "Chatbot COPY constructor from " << &source << " to instance " << this << std::endl;
}

ChatBot &ChatBot::operator=(const ChatBot &source)	// Copy assignmet operator
{
  if (this == &source)
    return *this;
...
ChatBot::ChatBot(ChatBot &&source)					// Moving constructor
{
  _currentNode = source._currentNode;
  _rootNode = source._rootNode;
  _image = source._image;
...
ChatBot &ChatBot::operator=(ChatBot &&source)		// Moving assignment
{
  if (this == &source)
  {
    return *this;
